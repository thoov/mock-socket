    ...
    */
    (0, _helpersDelay2['default'])(function () {
      ...
      if (server) {
        ...
        this.dispatchEvent((0, _factory.createEvent)({ type: 'close', target: this }));
