...
},{"./helpers/environment-check":10,"./server":14,"./websocket":15}],13:[function(require,module,exports){
Object.defineProperty(exports, '__esModule', {
  value: true
});
  ...
  _createClass(Server, [{
    ...
    */
    ...
    value: function send(data) {
      ...
      if (websocket) {
        return websocket.dispatchEvent((0, _eventFactory.createMessageEvent)({
          type: 'message',
          data: data,
          origin: this.url,
          target: websocket
...
module.exports = exports['default'];
},{"../URI.js":3,"./event-factory":5,"./event-target":6,"./helpers/close-codes":8,"./network-bridge":13,"./websocket":15}],15:[function(require,module,exports){
Object.defineProperty(exports, '__esModule', {
  value: true
});
