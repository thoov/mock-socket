  ...
  _createClass(WebSocket, [{
    ...
    */
    value: function close() {
      ...
      var server = _networkBridge2['default'].serverLookup(this.url);
      var closeEvent = (0, _factory.createCloseEvent)({ type: 'close', target: this, code: _helpersCloseCodes2['default'].CLOSE_NORMAL });
