    ...
    */
    value: function dispatchEvent(event, customArgument) {
      ...
      listeners.forEach(function (listener) {
        if (customArgument) {
          listener.call(_this, customArgument);
        } else {
