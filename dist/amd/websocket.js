define('websocket', ['exports', 'module', './helpers/delay', './event-target', './network-bridge', './helpers/close-codes', './helpers/normalize-url', './event-factory'], function (exports, module, _helpersDelay, _eventTarget, _networkBridge, _helpersCloseCodes, _helpersNormalizeUrl, _eventFactory) {
  'use strict';
  ...
  var _delay = _interopRequireDefault(_helpersDelay);
  ...
  var WebSocket = (function (_EventTarget) {
    ...
    */
    ...
    function WebSocket(url) {
      ...
      * // registered :-)
      */
      (0, _delay['default'])(function delayCallback() {
        if (server) {
      ...
      */
      ...
      value: function close() {
        ...
        var closeEvent = (0, _eventFactory.createCloseEvent)({
          type: 'close',
          target: this,
          code: _CLOSE_CODES['default'].CLOSE_NORMAL
        });
