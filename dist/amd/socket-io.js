define('socket-io', ['exports', 'module', './helpers/delay', './event-target', './network-bridge', './helpers/close-codes', './helpers/normalize-url', './event-factory'], function (exports, module, _helpersDelay, _eventTarget, _networkBridge, _helpersCloseCodes, _helpersNormalizeUrl, _eventFactory) {
  'use strict';
